  ...
  _BannerConfig _getBannerConfig(
    ...
    return switch (status) {
      PermissionGuardStatus.deviceServicesDisabled => _BannerConfig(
          ...
          subtitle: 'Enable location services to track shifts',
          actionLabel: 'Enable',
          canDismiss: false,
        ),
      PermissionGuardStatus.permanentlyDenied => _BannerConfig(
          ...
          subtitle: 'Enable in device settings to track shifts',
      ...
      PermissionGuardStatus.permissionRequired => _BannerConfig(
          ...
          subtitle: 'Grant permission to track shifts',
          actionLabel: 'Grant',
          canDismiss: false,
        ),
      PermissionGuardStatus.partialPermission => _BannerConfig(
          ...
          subtitle: 'Upgrade for continuous tracking',
          actionLabel: 'Upgrade',
          canDismiss: true,
        ),
      PermissionGuardStatus.batteryOptimizationRequired => _BannerConfig(
          ...
          subtitle: 'May interrupt tracking during shifts',
          actionLabel: 'Disable',
          canDismiss: true,
        ),

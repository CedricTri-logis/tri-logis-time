-- =============================================================================
-- 101: Compute effective_location_type on clusters after detect_trips
-- =============================================================================
-- Creates helper function compute_cluster_effective_types() and updates
-- detect_trips to call it as Step 8 after all clusters are created.
-- =============================================================================

-- Helper function: compute effective_location_type for all clusters in a shift
CREATE OR REPLACE FUNCTION compute_cluster_effective_types(
    p_shift_id UUID,
    p_employee_id UUID
) RETURNS VOID AS $$
BEGIN
...
-- =============================================================================
-- Re-create detect_trips with Step 8 added (call compute_cluster_effective_types)
-- =============================================================================

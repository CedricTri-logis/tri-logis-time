-- Migration 146: Add project sessions (cleaning + maintenance) to day approval detail
-- Returns cleaning_sessions and maintenance_sessions alongside activities for the "Projet(s)" column
...
BEGIN
    ...
    -- Build project sessions (cleaning + maintenance for this employee on this day)

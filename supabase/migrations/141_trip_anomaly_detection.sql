...
-- =========================================================================
-- Update get_day_approval_detail with anomaly detection (Task 4)
-- =========================================================================
...
BEGIN
    ...
    WITH activity_data AS (
        ...
        -- TRIPS (with cluster-based location fallback + anomaly detection)
        SELECT
            'trip'::TEXT,
            t.id,
            t.shift_id,
            ...
            t.gps_gap_seconds,
            t.gps_gap_count,
            -- auto_status with anomaly detection
            CASE
...
-- =========================================================================
-- Update get_weekly_approval_summary with anomaly detection (Task 5)
-- =========================================================================
...
BEGIN
    ...
    live_activity_classification AS (
        ...
        -- Trips with anomaly detection (mirrors get_day_approval_detail logic)
        SELECT
            t.employee_id,

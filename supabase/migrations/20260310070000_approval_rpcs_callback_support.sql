-- Update approval RPCs with callback shift support and 3h minimum grouping (Article 58 LNT)
-- Minimal diffs on top of 20260310010000_restore_lunch_in_approvals.sql

-- =========================================================================
-- 1. Update _get_day_approval_detail_base — add call billing + shift_type
-- =========================================================================
...
-- =========================================================================
-- 2. Update get_weekly_approval_summary — add call billing CTEs
-- =========================================================================
...
BEGIN
    ...
    -- Call billing with grouping (Article 58 LNT)
    -- Step 1: compute LAG values (cannot nest window functions)
    day_calls_lagged AS (
        SELECT
            employee_id,
    ...
    -- Step 2: compute group_id using SUM over the pre-computed LAG values
    day_calls AS (
        SELECT
            employee_id,
            call_date,

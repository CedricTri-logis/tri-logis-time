-- Migration 147: Add location_id to project sessions for location concordance
-- Allows frontend to filter sessions by GPS cluster location instead of just time overlap

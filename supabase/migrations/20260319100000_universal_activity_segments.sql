...
-- ============================================================
-- 7. Rewrite _get_day_approval_detail_base for universal segments
--    - Replace cluster_segments with activity_segments WHERE activity_type = 'stop'
--    - Add trip_segment_data CTE for trip segments
--    - Add gap segment handling
--    - Exclude segmented parents from stop/trip/gap outputs
-- ============================================================
...
-- ============================================================
-- 8. Rewrite get_weekly_approval_summary for universal segments
--    - Replace cluster_segments with activity_segments WHERE activity_type = 'stop'
--    - Add trip_segment_classification CTE for trip segments
--    - Exclude segmented parent trips from live_trip_classification
-- ============================================================

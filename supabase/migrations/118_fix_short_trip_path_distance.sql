-- =============================================================================
-- 118: Fix ghost trip filter — use path distance instead of displacement
-- =============================================================================
-- Bug: short driving trips between nearby buildings were deleted because the
-- straight-line displacement (haversine) was < 500m, even though the actual
-- GPS path distance was much larger (e.g. 1.33 km for a 264m displacement).
-- Fix: compute cumulative path distance from transit GPS points and use
-- GREATEST(haversine_distance, path_distance) for the driving ghost filter.
-- =============================================================================

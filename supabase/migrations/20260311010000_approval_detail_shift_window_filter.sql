...
--
-- Changes vs previous version (only 4 lines added, marked NEW):
--   stop_data:  JOIN shifts s_stop + AND sc.started_at >= s_stop.clocked_in_at - 10min
--   trip_data:  JOIN shifts s_trip + AND t.started_at >= s_trip.clocked_in_at - 10min

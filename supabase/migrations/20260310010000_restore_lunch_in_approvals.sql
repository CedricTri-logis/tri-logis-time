-- Restore lunch break support in approval functions
-- Both get_weekly_approval_summary and _get_day_approval_detail_base lost lunch support
-- when they were rewritten in migrations 146/147 without including lunch_breaks table queries.

-- =========================================================================
-- 1. Fix _get_day_approval_detail_base — add lunch breaks back
-- =========================================================================
...
-- =========================================================================
-- 3. Replace monolithic get_day_approval_detail with thin wrapper
--    that delegates to _get_day_approval_detail_base (with lunch support)
-- =========================================================================

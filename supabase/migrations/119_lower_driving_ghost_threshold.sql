-- =============================================================================
-- 119: Lower driving ghost trip threshold from 500m to 200m
-- =============================================================================
-- 500m was too aggressive — legitimate short trips between nearby buildings
-- (e.g. 24_Mgr-Latulipe-E <-> 284-288_Dallaire, 257m apart) were deleted
-- even with path distance fix. The 50m displacement filter already catches GPS noise.
-- Lowering to 200m matches v_min_distance_km and preserves all real trips.
-- 
-- =============================================================================

-- Migration 097: Fix trip location names in get_day_approval_detail
-- When trips have NULL start_location_id / end_location_id,
-- fall back to adjacent stationary clusters' matched locations.
-- Trips are created between clusters, so timestamps align exactly.

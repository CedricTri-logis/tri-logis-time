-- Add "never installed" filter and last_sign_in_at to get_monitored_team RPC
-- Enables filtering by: all, on-shift, off-shift, never-installed
-- Returns last_sign_in_at from auth.users for "sort by last connection" feature

-- =============================================================================
-- 114: Fix detect_trips search_path and compute_cluster_effective_types call
-- =============================================================================
-- Migration 113 deployed with two bugs:
--   1. SET search_path TO extensions (missing public schema)
--   2. compute_cluster_effective_types(p_shift_id) — needs 2 args
-- This re-deploys the same optimized function with both fixes.
-- =============================================================================

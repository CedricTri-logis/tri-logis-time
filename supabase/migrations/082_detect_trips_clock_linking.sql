-- =============================================================================
-- 082: Update detect_trips with clock-in/out cluster linking
-- =============================================================================
-- Adds clock-in/out location linking to the detect_trips function:
--   1. Loads clock-in/out coordinates from the shift record
--   2. After each cluster persist (INSERT or UPDATE), checks if the cluster
--      centroid is within 50m of clock-in/out coordinates
--   3. If matched, sets clock_in_cluster_id/clock_out_cluster_id and
--      clock_in_location_id/clock_out_location_id on the shift
--   4. Post-loop: any unlinked clock-in/out gets a direct location match
--      via match_trip_to_location
--
-- Only runs for completed shifts (v_create_clusters = TRUE).
-- Requires migration 081 (clock_in_cluster_id, clock_out_cluster_id,
-- clock_in_location_id, clock_out_location_id columns on shifts).
-- =============================================================================
